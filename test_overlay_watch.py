...
def child_make(q):
    try:
        ...
        clip = make_text_clip("DEBUG Overlay ✅", fontsize=80, color="white", size=(540, 960), duration=1)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if ok == "OK":
            print("parent: debug image written (check debug_child_saveframe.png or debug_child_getframe.png)")
            sys.exit(0)
        else:
