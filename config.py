...
GOOGLE_SERVICE_ACCOUNT_JSON = os.environ.get("SERVICE_ACCOUNT_FILE") or os.environ.get(
...
YOUTUBE_CLIENT_SECRETS = os.environ.get(
    "YOUTUBE_CLIENT_SECRETS", str((ROOT / "client_secret.json").resolve())
)
