...
print("stock clip size/duration/fps:", getattr(clip, "size", None), clip.duration, clip.fps, flush=True)

# make short overlay duration that matches clip
txt = make_text_clip("COMPOSITE TEST ✅", fontsize=120, color="white", size=clip.size, duration=min(3, clip.duration))
